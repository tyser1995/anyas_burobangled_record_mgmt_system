                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right add-user">
                            <a href="{{ route('accomodation.index') }}" class="btn btn-sm btn-primary" id="add-user">{{
                                __('Back to list') }}</a>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="post" action="{{ route('accomodation.store') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="type" id="type" required autofocus  placeholder="{{ __('Enter Name') }}">
                            </div>
                            <div class="form-group">
